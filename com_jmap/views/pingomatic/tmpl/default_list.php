...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<table class="full headerlist">
		<tr>
			...
			<td nowrap="nowrap">
				<a href="#pingomatic_stats" title="<?php echo JText::_('COM_JMAP_TITLE_PINGOMATIC_STATS');?>" class="fancybox btn btn-primary btn-xs absolute hidden-phone"><span class="glyphicon glyphicon-stats"></span> <?php echo JText::_( 'COM_JMAP_OPEN_PINGOMATIC_STATS' ); ?></a>
